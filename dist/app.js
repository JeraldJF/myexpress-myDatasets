...
var app = express();
const port = 3006;
const getDataSet_1 = __importDefault(require("./routes/getDataSet"));
const addDataSets_1 = __importDefault(require("./routes/addDataSets"));
const getDatasetById_1 = __importDefault(require("./routes/getDatasetById"));
const updateDataSet_1 = __importDefault(require("./routes/updateDataSet"));
const removeDataSet_1 = __importDefault(require("./routes/removeDataSet"));
const partialupdate_1 = __importDefault(require("./routes/partialupdate"));
